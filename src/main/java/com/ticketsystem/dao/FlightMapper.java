...
public interface FlightMapper {
    ...
    @Results({
        ...
        @Result(column="start_city", property="startCity", jdbcType=JdbcType.VARCHAR),
        @Result(column="end_city", property="endCity", jdbcType=JdbcType.VARCHAR),
