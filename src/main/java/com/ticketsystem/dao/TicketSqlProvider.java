...
public class TicketSqlProvider {
    ...
    public String insertSelective(Ticket record) {
        ...
        if (record.getPassengerName() != null) {
            sql.VALUES("passenger_name", "#{passengerName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPassengerName() != null) {
            sql.SET("passenger_name = #{record.passengerName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Ticket record) {
        ...
        if (record.getPassengerName() != null) {
            sql.SET("passenger_name = #{passengerName,jdbcType=VARCHAR}");
        }
